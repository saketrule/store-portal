Saket : I'm in a fix if we should use create-react-app, but will certainly speedup setup process
For now using default project structure of create-react-app; unsure if the additional dependencies will work later on
apparently uses chalk to build project
